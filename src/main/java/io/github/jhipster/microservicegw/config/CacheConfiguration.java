...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhSampleMicroserviceGW");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhSampleMicroserviceGW");
        ...
        config.getMapConfigs().put("io.github.jhipster.microservicegw.domain.*", initializeDomainMapConfig(jHipsterProperties));
